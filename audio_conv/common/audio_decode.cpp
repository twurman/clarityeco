...
//Print Some info about the input or output codec. 
void Audio_Service::printInputStat (AVCodecContext * codec_ctx){
 
  std::cout<<"Sample Format: "<<codec_ctx->sample_fmt<<std::endl;
  std::cout<<"BIT RATE: "<<codec_ctx->bit_rate<<std::endl;
  std::cout<<"SAMPLE RATE: "<<codec_ctx->sample_rate<<std::endl;
  std::cout<<"CHANNEL LAYOUT: "<<codec_ctx->channel_layout<<std::endl;
