...
export CLASSPATH=$CLASSPATH:~/clarityeco/qa/template:~/clarityeco/qa/template/gen-java
...
java -Djava.library.path=lib/search/ -server -Xms1024m -Xmx2048m QADaemon $1
