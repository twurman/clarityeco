# -*- coding: utf-8 -*-
"""
This sentiment analysis code is initially adapted by: Chang-Hong Hsu (hsuch@umich.edu) from (http://fjavieralba.com/basic-sentiment-analysis-with-python.html). Thrift support as well as logging is added to transform into a service by: Hailong Yang (hailong@umich.edu). Current version is using NLTK to perform POS of the sentences.
